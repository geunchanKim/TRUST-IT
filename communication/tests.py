...
class TestView(TestCase):
    ...
    def navbar_test(self, soup):
        ...
        self.assertEqual(blog_btn.attrs['href'], '/communication/')
    ...
    def test_post_detail(self):
        ...
        self.assertEqual(self.post_002.get_absolute_url(), '/communication/2/')
    ...
    def test_create_post(self):
        response = self.client.get('/communication/create_post/')
    ...
    def test_update_post(self):
        update_post_url = f'/communication/update_post/{self.post_003.pk}/'
    ...
    def test_comment_update(self):
        ...
        self.assertEqual(comment_001_update_btn.attrs['href'],'/communication/update_comment/1/')
        
        #추가
        self.assertIn('edit',comment_001_update_btn.text)
        self.assertEqual(comment_001_update_btn.attrs['href'],'/communication/update_comment/1/')
        
        response=self.client.get('/communication/update_comment/1/')
        self.assertEqual(response.status_code,200)
        ...
        response=self.client.post(
            f'/communication/update_comment/{self.comment_001.pk}/',
            {
    ...
    def test_delete_comment(self):
        ...
        self.assertEqual(
            ...
            '/communication/delete_comment/2/'
        )
        
        response = self.client.get('/communication/delete_comment/2/', follow=True)
        self.assertEqual(response.status_code,200)
        soup = BeautifulSoup(response.content,'html.parser')
    ...
    def test_search(self):
        ...
        response=self.client.get('/communication/search/파이썬/')
        self.assertEqual(response.status_code,200)
        soup=BeautifulSoup(response.content,'html.parser')
